      ...
      <div className=" w-full min-h-[150px] flex items-center gap-x-4">  
        ...
        <div className=" w-full flex flex-col ">
          <div className="flex justify-between mb-2 text-2xl">
            <Link
              to={`/product/${id}`}
              className=" text-sm uppercase max-w-[240] text-primary hover:text-blue-400  "
            >
              {title}
            </Link>
          ...
          <div className=" flex gap-x-2 h-[36px] text-sm ">
            <div className=" flex flex-1 max-w-[100px] items-center h-full border  text-primary font-medium ">
              <div onClick={()=> decreaseAmount(id)} className="flex h-full justify-center items-center cursor-pointer">
                <IoMdRemove />
              </div>
              <div className=" flex-1 flex items-center justify-around ">{amount} </div>
